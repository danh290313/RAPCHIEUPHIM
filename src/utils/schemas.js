...
const name = Yup.string().min(2, 'Name must be at least 2 characters').required('Name is required');
const nameSize = Yup.string().min(1, 'Name must be at least 2 characters').required('NameSize is required');

const email = Yup.string().email('Email is invalid').required('Email is required');
...
const description = Yup.string().min(15, 'Description must be at least 15 characters');
