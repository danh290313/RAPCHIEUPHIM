...
export function Profile() {
    ...
    const handleSubmit = (value) =>
    {
        ...
        const updateUserInfo = async () => {   
            ...
            response.status === 200 ? toastSuccess(response.message) : toastError(response.message);
                                ...
                                <Form>
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} md={6}>
                                            <FormGroup>
                                                <FastField name="name" component={InputMuiField} label="Họ & tên" />
                                            </FormGroup>
                                        </Grid>
                                        <Grid item xs={12} md={6}>
                                            <FormGroup>
                                        ...
                                        <Grid item xs={12} md={6}>
                                            <FormGroup>
                                                <Field name="address" component={InputMuiField} label="Địa chỉ" />
                                            </FormGroup>
                                        </Grid>
                                    </Grid>
